 ...
 */
export function isValidBase64Transaction(base64: string): boolean {
  try {
...
export const createDropSchema = z.object({
  ...
  (data) => data.streamerBps + data.prizePoolBps === 10000,
  { message: 'Streamer BPS + Prize Pool BPS must equal 10000 (100%)' }
);
